...
from senaite.arimporter import PRODUCT_NAME
from senaite.arimporter import PROFILE_ID
from senaite.arimporter import logger
...
def post_install(portal_setup):
    ...
    # Setup ID Formatting for ARImporter content types
...
def setup_workflows(portal):
    ...
    """
    logger.info("Setup arimporter workflow ...")
...
def setup_id_formatting(portal, format=None):
    """Setup default ID Formatting for arimporter content types
    """
    if not format:

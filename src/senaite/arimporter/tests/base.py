...
from senaite.arimporter.config import PRODUCT_NAME
...
class SimpleTestLayer(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        ...
        # Load ZCML
        import bika.lims
        import senaite.arimporter

        self.loadZCML(package=bika.lims)
        self.loadZCML(package=senaite.arimporter)
    ...
    def setUpPloneSite(self, portal):
        ...
        applyProfile(portal, "senaite.arimporter:default")
...
SIMPLE_TESTING = FunctionalTesting(
    ...
    name="senaite-arimporter:SimpleTesting"
)

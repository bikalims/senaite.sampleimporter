...
PRODUCT_NAME = "senaite.arimporter"
PROFILE_ID = "profile-{}:default".format(PRODUCT_NAME)

# Make senaite.arimporter modules importable by through-the-web
...
allow_module('senaite.arimporter.workflow.arimport.guards')
...
def initialize(context):
    ...
    logger.info("*** Initializing SENAITE.ARIMPORTER ***")

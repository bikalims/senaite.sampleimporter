# Contributing to senaite.arimporter

Third-party contributions are essential for keeping `senaite.arimporter` continuously 
improving. We simply cannot access the huge number of platforms and myriad 
configurations for running `senaite.arimporter`. We want to keep it as easy as 
...
The following is a set of guidelines for contributing to senaite.arimporter, which is 
...
bugs](https://github.com/senaite/senaite.arimporter/issues)? Do you have a
suggestion for improvement? Then by all means please [submit a new
issue](https://github.com/senaite/senaite.arimporter/issues/new), and do not
hesitate to comment on existing [open
issues](https://github.com/senaite/senaite.arimporter/issues).
...
platform (Operating System and version, how did you installed senaite.arimporter
...
The list of [open issues](https://github.com/senaite/senaite.arimporter/issues)
...
### Preliminaries
   ...
   2. [Fork senaite.arimporter from GitHub](
   https://github.com/senaite/senaite.arimporter/fork). This will copy the whole
   `senaite.arimporter` repository to your personal account.
   ...
   the actual username of your GitHub account):
          ...
          $ git clone https://github.com/YOUR_USERNAME/senaite.arimporter

   4. Your forked repository https://github.com/YOUR_USERNAME/senaite.arimporter will 
   receive the default name of `origin`. You can also add the original 
   `senaite.arimporter` repository, which is usually called `upstream`:

          $ cd senaite.arimporter
          $ git remote add upstream https://github.com/senaite/senaite.arimporter.git
...
```
$ git remote -v
origin    https://github.com/YOUR_USERNAME/senaite.arimporter.git (fetch)
origin    https://github.com/YOUR_USERNAME/senaite.arimporter.git (push)
upstream  https://github.com/senaite/senaite.arimporter.git (fetch)
upstream  https://github.com/senaite/senaite.arimporter.git (push)
```
...
Alternatively, you can merge `senaite.arimporter`'s `master` into your branch:
...
request](https://github.com/senaite/senaite.arimporter/compare/). Head to your
 ...
 * Add a changelog entry in [CHANGES.rst](https://github.com/senaite/senaite.arimporter/CHANGES.rst)

# Contributing to senaite.sampleimporter

Third-party contributions are essential for keeping `senaite.sampleimporter` continuously 
improving. We simply cannot access the huge number of platforms and myriad 
configurations for running `senaite.sampleimporter`. We want to keep it as easy as 
...
The following is a set of guidelines for contributing to senaite.sampleimporter, which is 
...
bugs](https://github.com/senaite/senaite.sampleimporter/issues)? Do you have a
suggestion for improvement? Then by all means please [submit a new
issue](https://github.com/senaite/senaite.sampleimporter/issues/new), and do not
hesitate to comment on existing [open
issues](https://github.com/senaite/senaite.sampleimporter/issues).
...
platform (Operating System and version, how did you installed senaite.sampleimporter
...
The list of [open issues](https://github.com/senaite/senaite.sampleimporter/issues)
...
### Preliminaries
   ...
   2. [Fork senaite.sampleimporter from GitHub](
   https://github.com/senaite/senaite.sampleimporter/fork). This will copy the whole
   `senaite.sampleimporter` repository to your personal account.
   ...
   the actual username of your GitHub account):
          ...
          $ git clone https://github.com/YOUR_USERNAME/senaite.sampleimporter

   4. Your forked repository https://github.com/YOUR_USERNAME/senaite.sampleimporter will 
   receive the default name of `origin`. You can also add the original 
   `senaite.sampleimporter` repository, which is usually called `upstream`:

          $ cd senaite.sampleimporter
          $ git remote add upstream https://github.com/senaite/senaite.sampleimporter.git
...
```
$ git remote -v
origin    https://github.com/YOUR_USERNAME/senaite.sampleimporter.git (fetch)
origin    https://github.com/YOUR_USERNAME/senaite.sampleimporter.git (push)
upstream  https://github.com/senaite/senaite.sampleimporter.git (fetch)
upstream  https://github.com/senaite/senaite.sampleimporter.git (push)
```
...
Alternatively, you can merge `senaite.sampleimporter`'s `master` into your branch:
...
request](https://github.com/senaite/senaite.sampleimporter/compare/). Head to your
 ...
 * Add a changelog entry in [CHANGES.rst](https://github.com/senaite/senaite.sampleimporter/CHANGES.rst)
